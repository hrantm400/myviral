...
import { Clapperboard, Video, Mic2, Music, Loader2, Play } from "lucide-react";
...
export default function CinematicCombo() {
  ...
  const uploadMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setBgMusic(null);
      setProjectName("");
      toast({ title: "Magic Combo Started!", description: "The Cinematic Storyteller pipeline is running" });
    },
    ...
    <div className="flex-1 w-full max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold tracking-tight text-amber-500 flex items-center gap-2">
          <Clapperboard className="w-6 h-6" /> Cinematic Storyteller
        </h1>
        <p className="text-sm text-muted-foreground mt-1">
          Sandwich ➡️ Color Grade ➡️ Ducking ➡️ Neon Subtitles
        </p>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="border-2 border-dashed border-amber-500/30 rounded-xl p-6 flex flex-col items-center bg-background">
                ...
                <span className="text-sm font-medium mb-2">Video</span>
              ...
              <div className="border-2 border-dashed border-amber-500/30 rounded-xl p-6 flex flex-col items-center bg-background">
                ...
                <span className="text-sm font-medium mb-2">Voice</span>
              ...
              <div className="border-2 border-dashed border-amber-500/30 rounded-xl p-6 flex flex-col items-center bg-background">
                ...
                <span className="text-sm font-medium mb-2">Music</span>
      ...
      {projects.length > 0 && (
        <div className="space-y-4">
          <h2 className="text-lg font-semibold">Your Cinematic Stories</h2>
